...
class Checker(TwoPlayerGame):
    ...
    def possible_moves_on_white_turn(self):
        #print("In possible moves on white turn")
        table_pos = []
        old_new_piece_pos = []
    ...
    def possible_moves_on_black_turn(self):
        #print("In possible moves on black turn")
        table_pos = []
        old_new_piece_pos = []
    ...
    def get_piece_pos_from_table(self, table_pos):
       # print("In get piece pos from table")
    ...
    def make_move(self, pos):
        ...
        self.players[self.current_player -
                     1].pos = self.get_piece_pos_from_table(pos)
        self.board = pos
        #print("The board is", self.board)
